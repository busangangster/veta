              ...
              ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    firestore
                        .collection('ToDo')
                        .doc('selected')
                        .set({"selected_time": "Expected time"});
                    Navigator.push(
                      //?? ??? ??? ?? ?? ???? ????.
                      context,
          ...
          children: [
            ...
            Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(flex: 4, child: Text("Expect time setting"))
                  ],
                )),
            SizedBox(
              height: 15,
            ...
            Container(
                ...
                child: ElevatedButton(
                    ...
                    child: Text(Provider.of<selectedProvider>(context)
                        .selectedTime
                        .toString()),
                    style: TextButton.styleFrom(
            ...
            Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(flex: 4, child: Text("Priority setting"))
                  ],
                )),
            Container(
              height: 20,
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(flex: 4, child: Text("Category setting"))
                ],
              ),
            ),
            SizedBox(
                ...
                children: [
                  DecoratedBox(
                    ...
                    decoration: BoxDecoration(
                      color: Colors.white,
                      border:
                          Border.all(color: const Color(0xffb936DFF), width: 1),
